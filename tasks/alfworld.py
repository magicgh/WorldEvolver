...
class Evalalfworld(BaseTask):
    def __init__(self,
        ...
        self.run_logger = TaskLogger(task_name="alfworld", log_path=log_path, max_num_steps=self.max_num_steps, baseline_dir=self.baseline_dir)
    ...
    def evaluate_env(self,  index, ob='', examples=None):
        ...
        for i in range(0, self.max_num_steps):
            ...
            if done:
                ...
                self.run_logger.log_example(index, True, reward, grounding_acc_count / (i + 1), score_change_record, env_details, trajectory)
        ...
        self.run_logger.log_example(index, done, progress_rate, grounding_acc_count / (i + 1), score_change_record, env_details, trajectory, example_prompt)
