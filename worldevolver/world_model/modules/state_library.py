...
class StateLibrary:
    ...
    def load_from_disk(self) -> int:
        ...
        with self._lock:
            self.records = list(load_library(self.env_name))
...
def get_library(env_name: str) -> EpisodicLibrary:

    lib = EpisodicLibrary(env_name)
    lib.load_records(list(load_library(env_name)))
    return lib
