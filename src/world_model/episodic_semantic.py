...
_DEFAULT_SF_CONFIDENCE_PCT = 0.0
...
class WMEpisodicSemantic(
    ...
    def predict(
        ...
        system = prompt_with_blocks(self._base_prompt, rules_block, cards_block)
    ...
    def load_checkpoint_state(self, state: Dict[str, Any]) -> None:
        ...
        if float(state.get("sf_confidence_pct", -1)) != self.sf_gate.confidence_pct:
            raise ValueError("checkpoint selective-foresight threshold mismatch")
